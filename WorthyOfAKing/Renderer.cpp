...
{
    if (point->X() - Game::camera->X() >= 0 && point->X() - Game::camera->X() < window->Width())
        if (point->Y() - Game::camera->Y() >= 0 && point->Y() - Game::camera->Y() < window->Height())
            PlotPixel(int(point->X() - Game::camera->X()), int(point->Y() - Game::camera->Y()), color);
}
...
{
    int x1 = int(line->Ax() - Game::camera->X());
    int y1 = int(line->Ay() - Game::camera->Y());
    int x2 = int(line->Bx() - Game::camera->X());
    int y2 = int(line->By() - Game::camera->Y());
